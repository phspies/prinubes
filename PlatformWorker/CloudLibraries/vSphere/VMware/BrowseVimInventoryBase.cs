...
namespace PlatformWorker.VMware
{
  ...
  {
    protected Dictionary<string, InventoryNode> _vcInventoryNodes = new Dictionary<string, InventoryNode>((IEqualityComparer<string>) StringComparer.CurrentCultureIgnoreCase);
    ...
    {
      string name = null;
      ManagedObjectReference parent = (ManagedObjectReference) null;
